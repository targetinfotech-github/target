...
class SetupContext():
    ...
    def get_common_context(self, url_type, flag, label, modal_url, view_url, create_url, update_url, master_data=None,
    ...
    def get_context(self):
        ...
        if self.operation == 'modal':
            ...
            context = self.get_common_context(url_type=url_type, flag=flag, label=label, modal_url=modal_url,
                                              view_url=view_url, create_url=create_url, update_url=update_url,
