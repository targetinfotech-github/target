...
# from apps.billing.models import Manufacturer
# from apps.billing.factories import ManufacturerFactory
#
# # class TestManufacturerCreate(TestCase):
# #     def createManufacturer(self):
# #         # Populate the database with 10 manufacturers
# #         for _ in range(1000):
# #             ManufacturerFactory.create()
# #
# #         self.assertEqual(Manufacturer.objects.count(), 10)
# #     def createProducts(self):
# #         for _ in range(1000):
# #             ProductFactory.create()
# #
# # class TestViews(TestCase):
# #     def viewManufacturer(self):
#
#
#
#
...
# from apps.billing.form import ManufacturerForm
